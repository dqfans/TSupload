...
URL | filename | username | password"""
    ...
    DOWNLOAD_START = "𝐓𝐫𝐲𝐢𝐧𝐠 𝐭𝐨 𝐝𝐨𝐰𝐧𝐥𝐨𝐚𝐝"
    UPLOAD_START = "𝐓𝐫𝐲𝐢𝐧𝐠 𝐭𝐨 𝐮𝐩𝐥𝐨𝐚𝐝"
    RCHD_BOT_API_LIMIT = "size greater than maximum allowed size (50MB). Neverthless, trying to upload."
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry. But, I cannot upload files greater than 1.5GB due to Telegram API limitations."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Successfully uploaded"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Successfully uploaded"
    NOT_AUTH_USER_TEXT = "Please /upgrade your subscription."
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.\nIf you think this is a bug, please contact <a href='https://telegram.dog/TSuploadbot'>@TSuploadbot</a>"
...
𝐒𝐞𝐧𝐝 /me 𝐭𝐨 𝐤𝐧𝐨𝐰 𝐜𝐮𝐫𝐫𝐞𝐧𝐭 𝐩𝐥𝐚𝐧 𝐝𝐞𝐭𝐚𝐢𝐥𝐬​"""
    ...
    EXTRACT_ZIP_ERRS_OCCURED = "Select file_name to upload from the below options. You can use /rename command after receiving file to rename it with custom thumbnail support."
